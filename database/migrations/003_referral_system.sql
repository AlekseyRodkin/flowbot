...
-- ====================================
CREATE OR REPLACE FUNCTION activate_referral(referred_user_id INTEGER)
RETURNS BOOLEAN AS $$
DECLARE
    ref_record RECORD;
    days_active INTEGER;
...
-- ====================================
-- 13. CRON ЗАДАЧА (выполнять раз в час)
-- ====================================
-- Эту функцию нужно вызывать из n8n или cron для проверки активации
-- SELECT check_referral_activity();
