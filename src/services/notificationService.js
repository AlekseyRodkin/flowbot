...
class NotificationService {
  ...
  async initialize() {
    try {
      ...
      // ТЕСТОВЫЙ ЦИКЛ на 13:42 (проверка очистки чата и прогресса дней)
      this.scheduleTestCycle1342();
      ...
      console.log(`🧪 TEST CYCLE: Will run at 13:42 MSK`);
    } catch (error) {
  ...
  // ТЕСТОВЫЙ ЦИКЛ на 13:42 (проверка очистки чата и полного цикла дня)
  scheduleTestCycle1342() {
    const jobName = 'test_cycle_1342';
    ...
    console.log('🧪 Scheduling TEST CYCLE at 13:42 MSK...');

    const job = cron.schedule('42 13 * * *', async () => {
      console.log(`\n🧪 ═══════════════════════════════════════`);
      console.log(`🧪 TEST CYCLE STARTED at 13:42 MSK`);
      console.log(`🧪 ═══════════════════════════════════════\n`);
    ...
    this.scheduledJobs.set(jobName, job);
    console.log('✅ Test cycle scheduled for 13:42 MSK');
  }
